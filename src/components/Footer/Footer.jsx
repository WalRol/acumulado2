      ...
      <div className="lay" >
        <section className="row footer-header">
          ...
          <section className="col-12 col-desksm-4 col-desk-3 footer-header__redes">
            ...
            <a href="https://www.facebook.com/lanacion" target="_blank" title="Seguirnos en Facebook"><i><svg xmlns="http://www.w3.org/2000/svg" fill="none" width="24" height="24" viewBox="0 0 24 24"><path xmlns="http://www.w3.org/2000/svg" d="M12 2C6.477 2 2 6.477 2 12C2 16.991 5.657 21.128 10.438 21.879V14.89H7.898V12H10.438V9.797C10.438 7.291 11.93 5.907 14.215  5.907C15.309 5.907 16.453 6.102 16.453 6.102V8.562H15.193C13.95 8.562 13.563 9.333 13.563 10.124V12H16.336L15.893  14.89H13.563V21.879C18.343 21.129 22 16.99 22 12C22 6.477 17.523 2 12 2Z" fill="#272727"></path></svg></i></a>
            <a href="https://twitter.com/LANACION" target="_blank" title="Seguirnos en Twitter"><i><svg xmlns="http://www.w3.org/2000/svg" fill="none" width="24" height="24" viewBox="0 0 24 24"><path xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" d="M22.162 5.65601C21.3985 5.9937 20.589 6.21548 19.76 6.31401C20.6337 5.79144 21.2877 4.96902 21.6 4.00001C20.78 4.48801 19.881 4.83001  18.944 5.01501C17.6498 3.63033 15.5863 3.2891 13.9153 4.18346C12.2442 5.07782 11.3836 6.98415 11.818 8.82901C8.45501 8.66045 5.32174 7.072  3.19799 4.45901C2.82628 5.09746 2.63095 5.82323 2.63199 6.56201C2.63199 8.01201 3.36999 9.29301 4.49199 10.043C3.828 10.0221 3.17862 9.84279  2.59799 9.52001V9.57201C2.5984 11.563 4.00151 13.2781 5.95299 13.673C5.33661 13.84 4.6903 13.8647 4.06299 13.745C4.61012 15.4492 6.18044  16.6168 7.96999 16.65C6.21793 18.026 3.99073 18.6491 1.77899 18.382C3.69069 19.6114 5.91609 20.2641 8.18899 20.262C15.882 20.262 20.089  13.889 20.089 8.36201C20.089 8.18201 20.084 8.00001 20.076 7.82201C20.8949 7.23017 21.6016 6.49703 22.163 5.65701L22.162 5.65601Z" fill="#272727"></path></svg></i></a>
            <a href="https://www.instagram.com/lanacioncom/" target="_blank" title="Seguirnos en Instagram"><i><svg xmlns="http://www.w3.org/2000/svg" fill="none" width="24" height="24" viewBox="0 0 24 24"><path xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" d="M12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9ZM12 7C14.7614 7 17 9.23858  17 12C17 14.7614 14.7614 17 12 17C9.23858 17 7 14.7614 7 12C7 9.23858 9.23858 7 12 7ZM18.5 6.75C18.5 7.44036 17.9404 8 17.25 8C16.5596 8 16  7.44036 16 6.75C16 6.05964 16.5596 5.5 17.25 5.5C17.9404 5.5 18.5 6.05964 18.5 6.75ZM12 4C9.526 4 9.122 4.007 7.971 4.058C7.187 4.095 6.661  4.2 6.173 4.39C5.739 4.558 5.426 4.759 5.093 5.093C4.78001 5.3954 4.53935 5.76458 4.389 6.173C4.199 6.663 4.094 7.188 4.058 7.971C4.006 9.075  4 9.461 4 12C4 14.474 4.007 14.878 4.058 16.029C4.095 16.812 4.2 17.339 4.389 17.826C4.559 18.261 4.759 18.574 5.091 18.906C5.428 19.242 5.741  19.443 6.171 19.609C6.665 19.8 7.191 19.906 7.971 19.942C9.075 19.994 9.461 20 12 20C14.474 20 14.878 19.993 16.029 19.942C16.811 19.905 17.338  19.8 17.826 19.611C18.259 19.442 18.574 19.241 18.906 18.909C19.243 18.572 19.444 18.259 19.61 17.829C19.8 17.336 19.906 16.809 19.942 16.029C19.994  14.925 20 14.539 20 12C20 9.526 19.993 9.122 19.942 7.971C19.905 7.189 19.8 6.661 19.61 6.173C19.4593 5.765 19.2191 5.39596 18.907 5.093C18.6047 4.77985  18.2355 4.53917 17.827 4.389C17.337 4.199 16.811 4.094 16.029 4.058C14.925 4.006 14.539 4 12 4ZM12 2C14.717 2 15.056 2.01 16.122 2.06C17.187 2.11 17.912  2.277 18.55 2.525C19.21 2.779 19.766 3.123 20.322 3.678C20.8305 4.1779 21.224 4.78259 21.475 5.45C21.722 6.087 21.89 6.813 21.94 7.878C21.987 8.944 22  9.283 22 12C22 14.717 21.99 15.056 21.94 16.122C21.89 17.187 21.722 17.912 21.475 18.55C21.2247 19.2178 20.8311 19.8226 20.322 20.322C19.822 20.8303  19.2173 21.2238 18.55 21.475C17.913 21.722 17.187 21.89 16.122 21.94C15.056 21.987 14.717 22 12 22C9.283 22 8.944 21.99 7.878 21.94C6.813 21.89 6.088  21.722 5.45 21.475C4.78233 21.2245 4.17753 20.8309 3.678 20.322C3.16941 19.8222 2.77593 19.2175 2.525 18.55C2.277 17.913 2.11 17.187 2.06 16.122C2.013  15.056 2 14.717 2 12C2 9.283 2.01 8.944 2.06 7.878C2.11 6.812 2.277 6.088 2.525 5.45C2.77524 4.78218 3.1688 4.17732 3.678 3.678C4.17767 3.16923 4.78243  2.77573 5.45 2.525C6.088 2.277 6.812 2.11 7.878 2.06C8.944 2.013 9.283 2 12 2Z" fill="#272727"></path></svg></i></a>
            <a href="https://www.lanacion.com.ar/arc/outboundfeeds/rss/?outputType=xml" target="_blank" title="Ir a Rss"><i><svg xmlns="http://www.w3.org/2000/svg" fill="none" width="24" height="24" viewBox="0 0 24 24"><path xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" d="M3 3C12.941 3 21 11.059 21 21H18C18 12.716 11.284 6 3 6V3ZM3 10C9.075 10 14 14.925 14 21H11C11 16.5817 7.41828 13 3 13V10ZM3 17C5.20914 17 7 18.7909 7 21H3V17Z" fill="#272727"></path></svg></i></a>
          </section>
