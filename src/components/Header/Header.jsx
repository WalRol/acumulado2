...
export default function Header() {
  ...
  useEffect(() => {
    ...
    const $headerMobile = document.querySelector('.com-nav-mobile');
  ...
  useEffect(() => {
    ...
    // Retornamos una función cleanup que remueve el evento click del hamburger
    return () => {
      $hamburger.removeEventListener('click', handleMenu);
    }
  }, []);
      ...
      <header className="header">
        <div className="lay" >
          <div className="row">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="icon" style={{marginTop: "2.5%"}}
                viewBox="0 0 512 512">
                <path
                    d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" />
            </svg> 
            <input type="text" className="com-search__input" placeholder="Buscar" onFocus={() => setInputFocused(true)}
                  onBlur={() => setInputFocused(false)} />
        </div>
            </form> */}
          ...
          y mediante un if de react dependiendo de x condicional dibujamos la caja correspondiente */}
              ...
              <div className="com-usuario">
                <button className="--btn --highlight hlp-marginRight-35" style={{marginTop: "2%"}}>Suscribite</button>
                <button className="--btn --secondary"  style={{marginTop: "2%"}}>Ingresar</button>
              </div>
            </div>
